...
export type DiwaTagNames = 'diwa-accordion' | 'diwa-badge' | 'diwa-button' | 'diwa-button-pure' | 'diwa-checkbox' | 'diwa-divider' | 'diwa-flyout' | 'diwa-heading' | 'diwa-icon' | 'diwa-inline-notification' | 'diwa-input-date' | 'diwa-input-email' | 'diwa-input-month' | 'diwa-input-number' | 'diwa-input-password' | 'diwa-input-search' | 'diwa-input-tel' | 'diwa-input-text' | 'diwa-input-time' | 'diwa-input-url' | 'diwa-input-week' | 'diwa-link' | 'diwa-link-pure' | 'diwa-modal' | 'diwa-multi-select' | 'diwa-multi-select-option' | 'diwa-pagination' | 'diwa-pin-code' | 'diwa-popover' | 'diwa-radio-group' | 'diwa-radio-group-item' | 'diwa-scroller' | 'diwa-segmented-control' | 'diwa-segmented-control-item' | 'diwa-select' | 'diwa-select-option' | 'diwa-spinner' | 'diwa-stepper-horizontal' | 'diwa-stepper-horizontal-item' | 'diwa-switch' | 'diwa-table' | 'diwa-table-body' | 'diwa-table-cell' | 'diwa-table-head' | 'diwa-table-head-cell' | 'diwa-table-row' | 'diwa-tabs' | 'diwa-tabs-bar' | 'diwa-tabs-item' | 'diwa-tag' | 'diwa-tag-dismissible' | 'diwa-text' | 'diwa-text-list' | 'diwa-text-list-item' | 'diwa-textarea' | 'diwa-toast' | 'diwa-toast-item';
