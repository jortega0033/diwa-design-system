...
export const FRAMEWORK_GUIDES: Record<FrameworkGuideKey, FrameworkGuide> = {
  'vanilla-js': {
    ...
    packageNames: '@diwa/components',
    installCommand: 'npm install @diwa/components',
  ...
  react: {
    ...
    packageNames: '@diwa/components + @diwa/components-react',
    installCommand: 'npm install @diwa/components @diwa/components-react',
    setupCode: `import React from 'react';\nimport { DButton } from '@diwa/components-react';\n\nexport function App() {\n  return <DButton variant="primary">Save</DButton>;\n}`,
    firstComponentCode: `import { DButton } from '@diwa/components-react';\n\nexport function SaveAction() {\n  return <DButton variant="primary">Save</DButton>;\n}`,
    eventCode: `import { DSelect } from '@diwa/components-react';\n\nexport function RegionSelect() {\n  return (\n    <DSelect\n      label="Region"\n      onUpdate={(event: CustomEvent<{ value: string }>) => {\n        console.log(event.detail.value);\n      }}\n    />\n  );\n}`,
    ssrAndTestingNotes: [
    ...
    troubleshooting: [
      'If TypeScript cannot find wrapper symbols, verify @diwa/components-react is installed in the app.',
  ...
  angular: {
    ...
    packageNames: '@diwa/components + @diwa/components-angular',
    installCommand: 'npm install @diwa/components @diwa/components-angular',
  ...
  vue: {
    ...
    troubleshooting: [
      'If wrapper imports fail, verify @diwa/components-vue is installed and resolved by the bundler.',
