...
const props = [
  ...
  { name: 'value', type: 'string', default: "''", description: 'Controlled value in YYYY-MM-DD format.' },
  ...
  { name: 'min', type: 'string', default: 'undefined', description: 'Minimum selectable date in YYYY-MM-DD format.' },
  { name: 'max', type: 'string', default: 'undefined', description: 'Maximum selectable date in YYYY-MM-DD format.' },
];


const events = [
  { name: 'change', detail: 'string', bubbles: 'true', description: 'Emitted when the user commits a date. Payload is YYYY-MM-DD.' },
  { name: 'input', detail: 'string', bubbles: 'true', description: 'Emitted on every value change. Payload is YYYY-MM-DD.' },
...
export default function InputDateApiPage() {
  return (
