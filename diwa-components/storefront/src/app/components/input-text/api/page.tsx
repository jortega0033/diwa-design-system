...
const sharedProps = [
  ...
  { name: 'value', type: 'string', default: "''", description: 'Controlled value (mutable). Reflects to the inner input.' },
...
const additionalProps = [
  { name: 'maxLength', type: 'number', default: 'undefined', description: 'Maximum number of characters the user can enter.' },
  { name: 'minLength', type: 'number', default: 'undefined', description: 'Minimum number of characters required.' },
  { name: 'spellCheck', type: 'boolean', default: 'undefined', description: 'Whether the browser should spell-check the value.' },
];

const props = [...sharedProps, ...additionalProps];


const events = [
  { name: 'change', detail: 'string', bubbles: 'true', description: 'Emitted when the user commits a value (on blur or Enter).' },
  { name: 'input', detail: 'string', bubbles: 'true', description: 'Emitted on every keystroke / value change.' },
...
export default function InputTextApiPage() {
  return (
