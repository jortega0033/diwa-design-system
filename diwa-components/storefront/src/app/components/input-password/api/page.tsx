...
const props = [
  ...
  { name: 'autoComplete', type: 'string', default: 'undefined', description: 'HTML autocomplete attribute. Use "current-password" for login and "new-password" for registration.' },
  { name: 'theme', type: "'dark' | 'light'", default: "'dark'", description: 'Per-component theme override. Reflects onto host data-theme.' },
  { name: 'showToggle', type: 'boolean', default: 'true', description: 'Shows the eye icon button that toggles password visibility. Set to false for confirm-password fields.' },
];
...
export default function InputPasswordApiPage() {
  return (
