...
const props = [
  ...
  { name: 'value', type: 'string', default: "''", description: 'Controlled value in YYYY-Www format (e.g. 2025-W24).' },
  ...
  { name: 'min', type: 'string', default: 'undefined', description: 'Minimum selectable week in YYYY-Www format.' },
  { name: 'max', type: 'string', default: 'undefined', description: 'Maximum selectable week in YYYY-Www format.' },
];


const events = [
  { name: 'change', detail: 'string', bubbles: 'true', description: 'Emitted when the user commits a week. Payload is YYYY-Www.' },
...
export default function InputWeekApiPage() {
  return (
