...
const props = [
  ...
  { name: 'showClearButton', type: 'boolean', default: 'true', description: 'Shows the × clear button when the field has a value and is not disabled or readonly.' },
];
...
export default function InputSearchApiPage() {
  return (
