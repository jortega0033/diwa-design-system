...
const props = [
  ...
  { name: 'value', type: 'string', default: "''", description: 'Controlled value in YYYY-MM format.' },
  ...
  { name: 'min', type: 'string', default: 'undefined', description: 'Minimum selectable month in YYYY-MM format.' },
  { name: 'max', type: 'string', default: 'undefined', description: 'Maximum selectable month in YYYY-MM format.' },
];


const events = [
  { name: 'change', detail: 'string', bubbles: 'true', description: 'Emitted when the user commits a month. Payload is YYYY-MM.' },
...
export default function InputMonthApiPage() {
  return (
